      ...
      <View style={{ flex: 1, padding: 16 }}>
         <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <View style={{ flexDirection: 'row', gap: 10 }}>
               ...
               <IconButton icon="trash" onPress={() => { handleDelete(id); navigation.goBack(); }} />
            </View>
         </View>
         <Text style={{ ...styles.title, fontSize: windowDimensions.width < 260 ? 24 : 32 }}>{title}</Text>
         <ScrollView>
            <Text style={{ ...styles.text, fontSize: windowDimensions.width < 260 ? 14 : 18 }}>{text}</Text>
         </ScrollView>
